...
class CustomBuildCardProposalStatusPending extends StatefulWidget {
  const CustomBuildCardProposalStatusPending({
    super.key,
  ...
  @override
  State<CustomBuildCardProposalStatusPending> createState() =>
      _CustomBuildCardStatusPenddingState();
}

class _CustomBuildCardStatusPenddingState
    extends State<CustomBuildCardProposalStatusPending> {
                        ...
                        : Column(
                            children: [
                              ...
                              _buildInfoRow(
                                ...
                                "المشرف:",
                                widget.proposal.supervisor,
                              ),

                              _buildInfoRow(
                                Iconsax.calendar_1, // 📅
                                "سنة التخرج:",
                                widget.proposal.year.toString(),
                              ),

                              if (widget.proposal.fileUrl != null &&
                                  widget.proposal.fileUrl!.isNotEmpty)
                                InkWell(
                                  onTap: () {
                                    log(
                                      "Opening file URL: ${widget.proposal.fileUrl}",
                                    );
                                    Navigator.pushNamed(
                                      context,
                                      AppRoutes.pdfviewer,
                                      arguments: widget.proposal.fileUrl,
                                    );
                                  },
                                  child: _buildInfoRow(
                              ...
                              Wrap(
                                spacing: 8.w,
                                runSpacing: 8.h,
                                children: widget.proposal.students
