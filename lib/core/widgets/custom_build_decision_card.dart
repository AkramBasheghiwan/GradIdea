...
class CustomBuildDecisionCards extends StatefulWidget {
  const CustomBuildDecisionCards({
    super.key,
  ...
  @override
  State<CustomBuildDecisionCards> createState() =>
      _CustomBuildDecisionCardState();
}

class _CustomBuildDecisionCardState extends State<CustomBuildDecisionCards> {
