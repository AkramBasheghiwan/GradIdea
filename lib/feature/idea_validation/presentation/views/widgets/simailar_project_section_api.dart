...
class SimailarProjectSectionApi extends StatelessWidget {
  const SimailarProjectSectionApi({super.key, required this.projects});
  final List<SimilarPaperMatch> projects;
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        ...projects.map((p) => _buildCard(context, p)),
      ],
    );
  }

  Widget _buildCard(BuildContext context, SimilarPaperMatch project) {
    return GestureDetector(
      onTap: () => Navigator.pushNamed(
        context,
        AppRoutes.getprojectstate,
        arguments: project.externalId,
      ),
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              child: Text(
                "${project.similarityScore.toStringAsFixed(0)}%",
