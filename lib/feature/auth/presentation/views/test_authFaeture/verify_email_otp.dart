...
import 'package:graduation_management_idea_system/feature/auth/presentation/views/test_authFaeture/verify_email_screan.dart';

class VerifyEmailOtp extends StatelessWidget {
  final String email; // نستقبل الإيميل من شاشة الـ SignUp
  const VerifyEmailOtp({required this.email, super.key});
