...
class SupervisorReviewProposalView extends StatelessWidget {
  const SupervisorReviewProposalView({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const SupervisorReviewTheProposalsBody(),
    );
  }
}

class SupervisorReviewTheProposalsBody extends StatelessWidget {
  const SupervisorReviewTheProposalsBody({super.key});
