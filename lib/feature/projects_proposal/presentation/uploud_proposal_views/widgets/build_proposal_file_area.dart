...
// import 'package:.../upload_proposal_cubit.dart';

class BuildProposalFileArea extends StatelessWidget {
  const BuildProposalFileArea({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<UploadProposalCubit, UploadProposalState>(
          ...
          children: [
            ...
            InkWell(
              onTap: hasFile
                  ...
                  : () => context
                        .read<UploadProposalCubit>()
                        .pickProposalFile(), // فتح منتقي الملفات
      ...
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                "جاهز للرفع",
                style: TextStyle(fontSize: 11.sp, color: AppColor.primaryColor),
              ),
            ],
          ),
        ),
        ...
        IconButton(
          ...
          onPressed: () {
            ...
            context.read<UploadProposalCubit>().clearSelectedFile();
          },
        ),
      ],
    );
