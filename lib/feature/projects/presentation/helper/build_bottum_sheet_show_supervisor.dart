...
Future<Map<String, String>?> buildBottumSheetShowSupervisor(
  ...
  return await showModalBottomSheet<Map<String, String>>(
    ...
    builder: (_) => BlocProvider(
      create: (_) => sl<FetchSupervisorCubit>()..fetchAvailableSupersior(),
      child: const _ShowSupervisorBottomSheetContent(),
    ),
  );
}

class _ShowSupervisorBottomSheetContent extends StatefulWidget {
  const _ShowSupervisorBottomSheetContent();

  @override
  State<_ShowSupervisorBottomSheetContent> createState() =>
      _SupervisorBottomSheetContentState();
}

class _SupervisorBottomSheetContentState
    extends State<_ShowSupervisorBottomSheetContent> {
  String search = '';

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<FetchSupervisorCubit, FetchSupervisorState>(
